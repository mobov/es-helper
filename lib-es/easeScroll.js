 ...
 * @param onFinish
 */
function scrollFunc(axis = 'x', $scroller, { justify = 0, target = 0, duration = 500, transition = 'sineaseOut', position = 'center', } = {}) {
...
export function scrollToX($scroller, scrollOpts) {
    return scrollFunc('x', $scroller, scrollOpts);
}
export function scrollToY($scroller, scrollOpts) {
