...
function scrollFunc() {
  ...
  return new Promise(function (resolve) {
    ...
    if (isDomTarget) {
      var rect = target.getBoundingClientRect(); // scroll = rect[META.start] - ($scroller[META.clientSize] - rect[META.size]) / 2 + justify
...
export { clip2Board as copy2Board, initClient, getClient, getStyle, strStyle, camelCase, getUrlParam, appendUrlParams, imageLoaded, RegexMap, isTrimEmpty, isEmail, isLowerCase, isUpperCase, isURL, isEmptyObject, isHexColor, isStyleUnit, isOSWindows, isOSIos, isOSAndroid, isMobile, scrollToY, scrollToX, sineaseOut, easeIn, strongEaseOut, strongEaseIn, sineaseIn, linear, findNode, deepCopy, deepEqual, arrayUnique, uniqueArrayByField };
