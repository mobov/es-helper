...
function scrollToX($scroller, _ref) {
...
function scrollToY($scroller, _ref2) {
  var _ref2$justify = _ref2.justify,
      justify = _ref2$justify === void 0 ? 0 : _ref2$justify,
      _ref2$$viewer = _ref2.$viewer,
      $viewer = _ref2$$viewer === void 0 ? null : _ref2$$viewer,
      _ref2$duration = _ref2.duration,
      duration = _ref2$duration === void 0 ? 500 : _ref2$duration,
      _ref2$transition = _ref2.transition,
      transition = _ref2$transition === void 0 ? 'sineaseOut' : _ref2$transition;
  ...
  var scroll = function () {
    if ($viewer) {
      ...
      return justify === 'start' ? -$scroller.scrollTop : justify === 'end' ? $scroller.scrollHeight - $scroller.clientHeight - $scroller.scrollTop : -justify;
    }
  }();
...
export { clip2Board as copy2Board, initClient, getClient, getStyle, strStyle, getUrlParam, appendUrlParams, imageLoaded, RegexMap, isTrimEmpty, isEmail, isLowerCase, isUpperCase, isURL, isEmptyObject, isHexColor, isStyleUnit, isOSWindows, isOSIos, isOSAndroid, isMobile, scrollToY, scrollToX, findNode, deepCopy, deepEqual, arrayUnique, uniqueArrayByField };
